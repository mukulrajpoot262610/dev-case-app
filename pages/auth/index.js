        ...
        <div className="flex flex-col items-center justify-center min-h-screen py-2">
            ...
            <div className="flex flex-col items-center justify-center rounded-xl md:shadow-2xl p-8 md:border border-gray-800">
                ...
                <button className="flex justify-center items-center btn btn-wide my-2">
                    <svg className="mr-2" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16">
                ...
                <button className="flex justify-center items-center btn btn-wide">
                    <svg className="mr-2" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-google" viewBox="0 0 16 16">
