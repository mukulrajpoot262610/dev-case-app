    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen py-2">
            ...
            <div className="flex flex-col items-center justify-center rounded-xl md:shadow-sm p-8 md:border border-gray-800">
                ...
                <button className="flex justify-center items-center btn btn-wide my-2" onClick={handleGithubLogin}>
                ...
                <button className="flex justify-center items-center btn btn-wide" onClick={handleGoogleLogin}>
                ...
                <form onSubmit={handleSubmit} className="w-full px-5">
                    ...
                    <div className="form-control w-full my-2">
                        <button className={`btn btn-wide ${loading && 'loading'}`}>Continue</button>
                    </div>
                </form>
